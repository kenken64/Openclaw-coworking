...
export const initialAgents: Agent[] = [
  { id: 'sage', name: 'SAGE', personName: 'Lisa', status: 'COMPUTING', progress: 71, room: 'jarvis', color: '#1e90ff', emoji: '🧙' },
  { id: 'atlas', name: 'ATLAS', personName: 'Michael', status: 'WORKING', progress: 78, room: 'jarvis', color: '#ff6b6b', emoji: '🗺️' },
  { id: 'clawd', name: 'CLAWD', personName: 'Sarah', status: 'WORKING', progress: 92, room: 'vibe', color: '#ffa502', emoji: '🦀' },
